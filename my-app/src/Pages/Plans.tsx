  ...
  return (
    <div className='w-full bg-white-400 h-[90vh] justify-center flex items-center'>
      <div className='border w-[400px] shadow-md bg-slate-50 h-[90%]'>
        <div className='font-bold text-[21px] h-[40px] bg-green-800 flex items-center justify-center text-[white]'>Fremo</div>
        <div className='font-bold  flex items-center justify-center text-[grey] mt-3'>Team up with your colleaques around your Api</div>
        <div className='font-bold  flex items-center justify-center text-[green] mt-3 text-[40px]'>$0</div>
        <div className='font-bold flex items-center justify-center text-[grey] mt-3 text-[12px]'>Free Trial for Zero Dollar/Month</div>
        <div className='font-bold flex items-center justify-center text-[white] mt-3 text-[12px]'>
            <Link to="/Register">
          <button className='border px-20 py-2 rounded-md bg-green-600 text-[20px]'>Select</button>
            </Link>
        </div>
        <div className='font-bold flex items-center justify-start text-[black] mt-3 text-[12px] ml-5'>Benefits for Zero Dollar/Month</div>
